...
export class CalendarService {
  static async list(
    ...
    // The four source queries are independent — run them concurrently rather
    // than waterfalling four round-trips on the calendar's hottest endpoint.
    const [projectRows, taskRows, peopleRows, reminderRows] = await Promise.all([
      db
